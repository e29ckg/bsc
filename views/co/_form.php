...
<?= $form->field($model, 'email', [
    ...
    'template' => '<section class="col col-6"><label class="label">{label}</label> <label class="input"> <i class="icon-append fa fa-envelope-o"></i>{input}<b class="tooltip tooltip-top-right">กรอก E-mail</b></label><em for="email" class="invalid">{error}{hint}</em></section>'
    ])->label(false);
    ?>
